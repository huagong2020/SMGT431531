...
`5.7-guided-lab-bayesian-team-forecasting.qmd` adds guided lab: bayesian team forecasting. The extracted script `R/guided_lab.R` runs from this lecture folder. Install `posterior` for Lectures 4 and 5, and `e1071` for Lecture 6. The new Gibbs examples run in R without Stan.
